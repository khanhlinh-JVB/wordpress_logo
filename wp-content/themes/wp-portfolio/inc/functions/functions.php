...
function wp_portfolio_scripts_styles_method() {
    ...
    wp_enqueue_style('mplus', get_template_directory_uri() . '/mplus.css', array(), false, true);
    wp_enqueue_style('font', get_template_directory_uri() . '/font.css', array(), false, true);
    wp_enqueue_style('icon', get_template_directory_uri() . '/icon.css', array(), false, true);
    wp_enqueue_style('component', get_template_directory_uri() . '/component.css', array(), false, true);
    if (is_singular('pages')) {
        wp_enqueue_style('component', get_template_directory_uri() . '/pages.css', array(), false, true);
    }
    /**
...
//    }
     ...
     */
    wp_enqueue_script('wp-portfolio-scripts', get_template_directory_uri() . '/js/jquery-1.12.1.min.js', array('jquery'), false, true);
    wp_enqueue_script('wp-portfolio-scripts', get_template_directory_uri() . '/js/common.js', array('jquery'), false, true);
    wp_enqueue_script('wp-portfolio-scripts', get_template_directory_uri() . '/js/smoothscroll.js', array('jquery'), false, true);
    wp_enqueue_script('wp-portfolio-scripts', get_template_directory_uri() . '/js/jquery.freetile.min.js', array('jquery'), false, true);
}
